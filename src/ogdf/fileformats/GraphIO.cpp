 ...
 * last checkin:
 *   $Author: gutwenger $
 *   $Date: 2013-04-04 19:43:53 +0530 (Thu, 04 Apr 2013) $
 ***************************************************************/
...
//---------------------------------------------------------
// Graph: GML formatEMSCRIPTEN_BINDINGS(graphattributes) {
...
char* GraphIO::writeGML(const Graph &G, const string &filename)
{
