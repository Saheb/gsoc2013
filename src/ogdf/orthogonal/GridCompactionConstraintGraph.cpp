...
/** \file
 * \brief Implementation of class GridCompactionConstraintGraphBase.
 *
...
GridCompactionConstraintGraphBase::GridCompactionConstraintGraphBase(
	const OrthoRep &OR,
	const PlanRep &PG,
	OrthoDir arcDir) :
		m_pathNode(OR),
...
void GridCompactionConstraintGraphBase::insertPathVertices(const PlanRep &PG)
{
...
void GridCompactionConstraintGraphBase::dfsInsertPathVertex(
	node v,
	node pathVertex,
...
void GridCompactionConstraintGraphBase::insertBasicArcs(const PlanRep &PG)
{
	const Graph &G = *m_pOR;
...
// face
void GridCompactionConstraintGraphBase::embed()
{
...
#ifdef foutput
writeGML("c:\\temp\\CCgraph%d.gml");//,randomNumber(0,20)));
...
//   with length 0.
void GridCompactionConstraintGraphBase::computeTopologicalSegmentNum(
...
// (as basic arcs)
void GridCompactionConstraintGraphBase::removeRedundantVisibArcs(
...
void GridCompactionConstraintGraphBase::writeGML(const char *filename) const
{
	ofstream os(filename);
	writeGML(os);
}
void GridCompactionConstraintGraphBase::writeGML(const char *filename, NodeArray<bool> one) const
{
	ofstream os(filename);
	writeGML(os, one);
}

void GridCompactionConstraintGraphBase::writeGML(ostream &os) const
{
	const Graph &G = *this;
...
void GridCompactionConstraintGraphBase::writeGML(ostream &os, NodeArray<bool> one) const
{
	const Graph &G = *this;
