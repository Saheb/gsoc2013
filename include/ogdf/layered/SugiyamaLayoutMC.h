 ...
 * last checkin:
 *   $Author: gutwenger $
 *   $Date: 2013-05-02 14:13:51 +0530 (Thu, 02 May 2013) $
 ***************************************************************/

/** \file
 * \brief Declaration of Sugiyama algorithm for multicore architectures.
 *
...
#ifndef OGDF_SUGIYAMA_LAYOUT_MC_H
#define OGDF_SUGIYAMA_LAYOUT_MC_H
 ...
 * </table>
 */
class OGDF_EXPORT SugiyamaLayoutMC : public LayoutModule {
...
public:
	...
	/**
	 * \brief Calls the layout algorithm for graph \a GA with a given level assignment.
	 *
	 * Returns the computed layout in \a GA.
	...
	bool evenOdd() const { return m_evenOdd; }
	void evenOdd(bool b) { m_evenOdd = b; }

	int sortAfterLayers() const { return m_sortAfterLayers; }
	void sortAfterLayers(int n) { m_sortAfterLayers = n; }
...
protected:
	...
	void reduceCrossingsEvenOdd(HierarchyLevels &levels);

	void barycenter(Level &L, bool doSorting);
...
private:
	...
	int traverseEvenOdd(HierarchyLevels &levels);
