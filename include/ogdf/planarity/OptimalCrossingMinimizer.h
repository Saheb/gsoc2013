...
//				#endif
	...
	public:
		...
		Master() :
				abacus::Master("OptimalCrossingMinimizer::Master",1, true ,abacus::OptSense::Min),
...
public:
	friend class DeletingTop10Heap<OptimalCrossingMinimizer::KuratowskiConstraint,double,Compare_Equals<OptimalCrossingMinimizer::KuratowskiConstraint> >;
